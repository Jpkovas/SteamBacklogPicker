...
public sealed class LocalizationService : ILocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Portuguese = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Filters_RequireMultiplayer"] = "Apenas multijogador ou coop",
        ...
        ["Filters_MoodTags_HelpText"] = "Separe por vírgulas ou ponto e vírgula para exigir marcadores específicos",
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Filters_PlayModesLabel"] = "PLAY MODES",
        ["Filters_RequireSinglePlayer"] = "Require singleplayer",
        ["Filters_RequireMultiplayer"] = "Require multiplayer or co-op",
        ["Filters_RequireVirtualReality"] = "Require VR support",
        ...
        ["Filters_MoodTags_HelpText"] = "Separate with commas or semicolons to require matching tags",
